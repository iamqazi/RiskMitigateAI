...
const Banner = () => {
  ...
  return (
    <section className="max-w-[1181px]  lg:mt-2  mx-auto pb-[60px] bg-black px-4 md:px-6">
      <div className="bg-[#01F2A7] px-6 md:px-8 rounded-[24px] h-auto md:h-[260px] flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
